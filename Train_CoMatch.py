...
from shakeshake26 import cifar_shakeshake26
...
def set_model(args):
    if args.arch == 'WideResnet':
        ...
        model = cifar_shakeshake26(pretrained=False, num_classes=args.n_classes, proj=True)
    if args.checkpoint:
    ...
    if args.eval_ema:
        if args.arch == 'WideResnet':
            ...
            ema_model = cifar_shakeshake26(pretrained=False, num_classes=args.n_classes, proj=True)
